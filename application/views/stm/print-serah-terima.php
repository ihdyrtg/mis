            ...
            <section class="invoice">
                ...
                <div class="row invoice-info">
                    <div class="col-sm-12 invoice-col">
                        <h5 class="text-center text-bold mb-3 mt-3">SERAH TERIMA STM</h5>
                    </div>
                    <!-- /.col -->
                ...
                <?php if ($this->uri->segment(4) == null) : ?>
                    <div class="row">
                        <div class="col-12">
                            <p>Pada hari ini <?php echo tgl_hari($serah['tanggal_serah']); ?> telah diserahkan STM sejumlah Rp. <?php echo number_format($serah['jumlah_serah']); ?> berbentuk <?php echo $serah['terbilang']; ?> kepada, <?php if (gender($serah['kepada']) == 'lk') : ?> Bapak <?php else : ?> Ibu <?php endif; ?> <?php echo $serah['nama_pegawai']; ?>.</p>
                ...
                <?php else : ?>
                    <div class="row">
                        <div class="col-12">
                            <P>Pada hari ini <?php echo tgl_hari($serah2['tanggal_serah']); ?> telah diserahkan STM sejumlah Rp. <?php echo number_format($serah2['jumlah_serah']); ?> berbentuk <?php echo $serah2['terbilang']; ?> kepada, <?php if (gender($serah2['kepada']) == 'lk') : ?> Bapak <?php else : ?> Ibu <?php endif; ?> <?php echo $serah2['nama_pegawai']; ?>.</P>
                            <p>Demikian disampaikan semoga dapat dipergunakan sebagaimana mestinya.</p>
                        </div>
                        <!-- /.col -->
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <br><br>
                        <p class="lead">Yang Menerima STM</p>
                        <br><br><br>
                        <?php if ($this->uri->segment(4) == null) : ?>
                            <p class="lead"><?php echo $serah['nama_pegawai']; ?></p>
                        <?php else : ?>
                            <p class="lead"><?php echo $serah2['nama_pegawai']; ?></p>
                        <?php endif; ?>
                    </div>
                    <!-- /.col -->
                    <div class="col-4">
                        <p class="lead">Padangsidimpuan, <?php echo tgl_bulan(date('j  M  Y')); ?></p>
                        <p class="lead">Bendahara STM</p>
                        <br><br><br>
