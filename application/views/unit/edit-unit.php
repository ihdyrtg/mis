            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('masterdata/unit'); ?>">Unit Kerja</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?php echo form_open_multipart('masterdata/edit_unit/' . $unit['id_unit']); ?>
                        <input type="hidden" name="id_unit" id="id_unit" value="<?php echo $unit['id_unit']; ?>">
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="nama_unit">Unit Kerja</label>
                                    <input type="text" class="form-control" name="nama_unit" id="nama_unit" placeholder="Nama pegawai" value="<?php echo $unit['nama_unit']; ?>">
