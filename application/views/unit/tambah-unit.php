            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?php echo form_open_multipart('masterdata/tambah_unit'); ?>
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="nama_unit">Unit Kerja</label>
                                    <input type="text" class="form-control" name="nama_unit" id="nama_unit" placeholder="Nama unit kerja" value="<?php echo set_value('nama_unit'); ?>">
