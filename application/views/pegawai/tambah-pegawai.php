            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?php echo form_open_multipart('masterdata/tambah_pegawai'); ?>
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="id_pegawai">Id Pegawai</label>
                                    <input type="text" class="form-control" name="id_pegawai" id="id_pegawai" placeholder="001" value="<?php echo set_value('id_pegawai'); ?>">
                                    <?php echo form_error('id_pegawai', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group col-md-9">
                                    <label for="nama_pegawai">Nama Pegawai</label>
                                    <input type="text" class="form-control" name="nama_pegawai" id="nama_pegawai" placeholder="Nama Pegawai" value="<?php echo set_value('nama_pegawai'); ?>">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="bagian" id="bagian" class="form-control">
                                        ...
                                        <?php foreach ($bagian as $b) : ?>
                                            <option value="<?php echo $b['id_bagian']; ?>"><?php echo $b['nama_bagian']; ?>
                                            <?php endforeach; ?>
                                    </select>
