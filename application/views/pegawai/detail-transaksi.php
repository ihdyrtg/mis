...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <a href="<?php echo base_url('masterdata/print_detail/' . $this->uri->segment(3)); ?>" class="btn bg-gradient-info btn-sm mb-2"><i class="fas fa-print"></i> Print Laporan</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($barang_keluar as $bk) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $bk['jumlah']; ?></td>
