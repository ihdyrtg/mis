            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('masterdata/detail/') . $this->uri->segment(3); ?>">Detail Transaksi</a></li>
            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo base_url('masterdata/detail/' . $this->uri->segment(3)); ?>" class="btn btn-tool">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <form action="<?php echo base_url('pelaporan/print_permintaan'); ?>" method="post" target="_blank">
