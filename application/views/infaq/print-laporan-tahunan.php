        ...
        <div class="container">
            <section class="invoice">
                ...
                <div class="row">
                    <div class="col-12 table-responsive">
                        <table border="1" cellpadding="5">
                            ...
                            <tbody>
                                <?php $no = 1; ?>
                                <?php foreach ($laporan_infaq as $row) : ?>
                                    <tr>
                                        <td width="50" class="text-center"><?php echo $no; ?></td>
                                        <td><?php echo hanya_bulan($row['tanggal_serah']); ?></td>
                            ...
                            <tfoot>
                                ...
                                <th>Rp. <?php echo number_format($sum_tahun['total_laporan']); ?></th>
                            </tfoot>
                        </table>
                    </div>
                    <!-- /.col -->
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <br><br>
                        <p class="lead"> <br> Petugas Pengutip Infaq</p>
                        <br><br><br>
